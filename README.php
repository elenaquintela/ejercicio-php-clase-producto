<?php
// Crear una clase Producto con tres campos: id, nombreProducto, precio. Este tendrá un método estático llamado "aplicarDescuento25" que recibirá un argumento que es el precio del producto y devolverá el precio del producto una vez aplicado el descuento del 25%
